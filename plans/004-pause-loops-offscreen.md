...
```css
/* web/src/app/globals.css:283 — current */
.tape-track {
  animation: tape 42s linear infinite;
}
/* web/src/app/globals.css:298 — current */
.ball-wraps {
...
Used by the hero yarn ball and marquee (`web/src/components/home/Hero.tsx:55`, `:65`) and the auth layout (`web/src/app/(auth)/layout.tsx:40`, `:51`). The loop elements are rendered here:
